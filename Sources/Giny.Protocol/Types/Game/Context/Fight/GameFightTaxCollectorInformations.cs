...
{
    public new const ushort Id = 5929;
    ...
    public GameFightTaxCollectorInformations(short firstNameId, short lastNameId, double contextualId, EntityDispositionInformations disposition, EntityLook look, GameContextBasicSpawnInformation spawnInfo, byte wave, GameFightCharacteristics stats, short[] previousPositions)
    {
