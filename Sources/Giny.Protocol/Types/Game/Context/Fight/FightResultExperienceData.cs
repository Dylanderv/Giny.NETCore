...
{
    public new const ushort Id = 3328;
    ...
    public override void Serialize(IDataWriter writer)
    {
        ...
        if (experienceFightDelta < 0 || experienceFightDelta > 9007199254740992)
        {
        ...
        if (experienceForGuild < 0 || experienceForGuild > 9007199254740992)
        {
        ...
        if (experienceForMount < 0 || experienceForMount > 9007199254740992)
        {
