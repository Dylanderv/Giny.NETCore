...
public class SocialEmblem
{
    ...
    public SocialEmblem(short symbolShape, int symbolColor, byte backgroundShape, int backgroundColor)
    {
    ...
    public virtual void Deserialize(IDataReader reader)
    {
        ...
        if (symbolShape < 0)
        {
            throw new System.Exception("Forbidden value (" + symbolShape + ") on element of SocialEmblem.symbolShape.");
        }
        ...
        if (backgroundShape < 0)
        {
            throw new System.Exception("Forbidden value (" + backgroundShape + ") on element of SocialEmblem.backgroundShape.");
        }
