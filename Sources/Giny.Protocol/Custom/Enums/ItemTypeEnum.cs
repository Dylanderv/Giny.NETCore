...
public enum ItemTypeEnum
{
    ...
    SMITHMAGIC_ENGRAVING = 258,
    KLONEBAWKS = 259,
    EVIL_FOREST = 260,
    MODSTERS = 261,
    MEGALTERATION_MATERIALS = 262,
    BADGE = 265,
    TEMPORAL_ANOMALY_RESOURCES = 266,
    EXPEDITION_IDOL = 267,
    EXPEDITIONS = 268,
    LANCE = 271,
    ARCHIPELAGO_OF_VALONIA = 272,
    PERCEPTOR_SHOES = 273,
    PERCEPTOR_ARMOUR = 274,
    PERCEPTOR_BANNER = 275,
    PERCEPTOR_DAGGERS = 276,
    PERCEPTOR_TUNIC = 277,
    PERCEPTOR_RESOURCES = 278,
    PERCEPTOR_CHESTS = 279,
    PERCEPTOR_BAGS = 280,
    INCARNATION_RELIC = 284,
    TEMPORIS_SIDEKICK = 286,
    SIDEKICK_SIGNAL_CARRIER = 287,
    QUEST_IDOLS = 289,
