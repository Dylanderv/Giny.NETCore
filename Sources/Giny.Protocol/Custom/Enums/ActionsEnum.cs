...
public enum ActionsEnum
{
    ...
    ACTION_CHARACTER_LIFE_POINTS_WIN_FROM_FIRE = 108,
    ...
    ACTION_DEBOOST_OCCUPIED_CELL = 297,
    ACTION_DEBOOST_FREE_CELL = 298,
    ACTION_BOOST_FREE_CELL = 299,
    ACTION_FIGHT_DISPELL_TEMPORARY_OBJECT = 310,
    ACTION_BOOST_OCCUPIED_CELL = 314,
    ...
    ACTION_BOOST_VISIBLE_TARGET_ON_CELL_ON = 798,
    ACTION_BOOST_VISIBLE_TARGET_ON_CELL_OFF = 799,
    ...
    ACTION_ITEM_BUFF_CHANGE_DURATION_WIN = 817,
    ACTION_ITEM_BUFF_CHANGE_DURATION_LOSE = 818,
    ...
    WIPWIPWIP = 2831,
    ACTION_CHARACTER_LIFE_POINTS_LOST_FROM_WORST_ELEMENT = 2832,
    ...
    ACTION_GAIN_LEVEL = 2878,
    ACTION_CHARACTER_INVENTORY_ADD_PERFECT_ITEM_CHECK = 2879,
    ACTION_ITEM_CUSTOM_EFFECT = 2880,
    ACTION_SELF_PILOTING = 2881,
    ACTION_DISTRIBUTE_GAMEACTION = 2882,
    ACTION_SET_TURN_WAITING_TIME = 2883,
    ACTION_CHARACTER_SEND_INFORMATION_TEXT_TO_MAP = 2884,
    ACTION_CHARACTER_SEND_INFORMATION_TEXT_TO_SUBAREA = 2885,
    ACTION_CHARACTER_SEND_INFORMATION_TEXT_TO_AREA = 2886,
    ACTION_CHARACTER_SEND_INFORMATION_TEXT_TO_WORLD = 2887,
    ACTION_UNKNOWN = 2888,
    ACTION_CHARACTER_OPEN_GUILD_STORAGE = 2889,
    ACTION_CHARACTER_LIFE_POINTS_STEAL_FROM_WORST_ELEMENT = 2890,
    ACTION_FIGHT_SPLASH_FINAL_TAKEN_DAMAGE_WORST_ELEMENT = 2891,
    ACTION_CHARACTER_ADD_ALTERATION = 2892,
    ACTION_CHARACTER_REMOVE_ALTERATION = 2893,
    ACTION_CHARACTER_SPEED_MULTIPLIER = 2894,
    ACTION_ITEM_TELEPORT_GROUP_TO_ME = 2895,
    ACTION_FIGHT_SPLASH_RAW_TAKEN_DAMAGE_WORST_ELEMENT = 2896,
    ACTION_CHARACTER_LIMIT_STATS = 2897,
    ACTION_MULTIPLY_VICTORY_POINTS_AVA = 2898,
    ACTION_MULTIPLY_DEFEAT_POINTS_AVA = 2899,
    ACTION_SEE_ALLIES_ROLE_AVA = 2900,
    ACTION_SEE_OPPONENT_ROLE_AVA = 2901,
    ACTION_TEAM_POINTS_LOST_AVA = 2902,
    ACTION_STORE_POINTS_AVA = 2903,
    ACTION_SPEND_POINTS_AVA = 2904,
    ACTION_SET_SPELL_RANGE_MAX = 2905,
    ACTION_SET_SPELL_RANGE_MIN = 2906,
    ACTION_ADD_PRISM_CRISTAL = 2907,
    ACTION_BOOST_PORTAL_FREE_CELL_OFF = 2908,
    ACTION_BOOST_PORTAL_PROJECTION_ON = 2909,
    ACTION_BOOST_PORTAL_PROJECTION_OFF = 2910,
    ACTION_BOOST_PORTAL_FREE_CELL_ON = 2911,
    ACTION_SET_SPELL_AP_COST = 2913,
    ACTION_DISABLE_SPELL_RANGEABLE = 2914,
    ACTION_ENABLE_SPELL_NOLINEOFSIGHT = 2915,
    ACTION_SET_SPELL_MAXPERTARGET = 2916,
    ACTION_DEBOOST_SPELL_MAXPERTARGET = 2917,
    ACTION_SET_SPELL_MAXPERTURN = 2918,
    ACTION_DEBOOST_SPELL_MAXPERTURN = 2919,
    ACTION_BOOST_SPELL_CAST_GLOBAL_INTVL = 2920,
    ACTION_DEBOOST_SPELL_CAST_GLOBAL_INTVL = 2921,
    ACTION_SET_SPELL_CAST_GLOBAL_INTVL = 2922,
    ACTION_BOOST_SPELL_MAX_STACK = 2923,
    ACTION_DEBOOST_SPELL_MAX_STACK = 2924,
    ACTION_SET_SPELL_MAX_STACK = 2925,
    ACTION_DEBOOST_SPELL_CRITICAL_HIT = 2926,
    ACTION_SET_SPELL_CRITICAL_HIT = 2927,
    ACTION_DEBOOST_SPELL_HEAL = 2928,
    ACTION_SET_SPELL_HEAL = 2929,
    ACTION_DEBOOST_SPELL_DMG = 2930,
    ACTION_SET_SPELL_DMG = 2931,
    ACTION_ENABLE_SPELL_CASTOUTLINE = 2932,
    ACTION_DISABLE_SPELL_CASTOUTDIAGONAL = 2933,
    ACTION_ENABLE_SPELL_CASTOUTDIAGONAL = 2934,
    ACTION_BOOST_SPELL_BASE_HEAL = 2935,
    ACTION_CASTER_EXECUTE_SPELL_ON_CELL = 2960,
    ACTION_CHARACTER_BOOST_DEALT_HEAL_PERCENT_MULTIPLIER = 2971,
    ACTION_CHARACTER_DEBOOST_DEALT_HEAL_PERCENT_MULTIPLIER = 2972,
    ACTION_FIGHT_CASTER_SPLASH_HEAL = 2973,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_AIR = 2974,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_WATER = 2975,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_FIRE = 2976,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_EARTH = 2977,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_NEUTRAL = 2978,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_BEST_ELEMENT = 2979,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE_WORST_ELEMENT = 2980,
    ACTION_FIGHT_SPLASH_RAW_INFLICTED_DAMAGE = 2981,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_AIR = 2982,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_WATER = 2983,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_FIRE = 2984,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_EARTH = 2985,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_NEUTRAL = 2986,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_BEST_ELEMENT = 2987,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE_WORST_ELEMENT = 2988,
    ACTION_FIGHT_SPLASH_FINAL_INFLICTED_DAMAGE = 2989,
    ACTION_CHARACTER_REDUCE_MAXIMUM_SUMMONED_CREATURES = 2990,
    ACTION_LOCK_PRISM_MODULE = 2991,
    ACTION_CHARACTER_READ_GUIDE = 2992,
    ACTION_CHARACTER_RENAME_INVALID_ALLIANCE = 2993,
    ACTION_REDUCE_PRISM_DURABILITY_REDUCTION = 2994,
    ACTION_TEAM_POINTS_WIN_AVA = 2995,
    ACTION_DURATION_HOUR = 2996,
    ACTION_CHARACTER_LEARN_SPELL_TEMPORARY_MUTANT = 2997,
    ACTION_CHARACTER_LIFE_POINTS_WIN_FROM_WATER = 2998,
    ACTION_CHARACTER_LIFE_POINTS_WIN_FROM_AIR = 2999,
    ACTION_CHARACTER_LIFE_POINTS_WIN_FROM_EARTH = 3000,
    ACTION_CHARACTER_LIFE_POINTS_WIN_FROM_NEUTRAL = 3001,
