...
public class TaxCollectorAttackedMessage : NetworkMessage
{
    ...
    public TaxCollectorAttackedMessage(short firstNameId, short lastNameId, short worldX, short worldY, double mapId, short subAreaId, BasicAllianceInformations alliance)
    {
