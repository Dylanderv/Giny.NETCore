...
public class GameFightSpectateMessage : NetworkMessage
{
    ...
    public GameFightSpectateMessage(FightDispellableEffectExtendedInformations[] effects, GameActionMark[] marks, short gameTurn, int fightStart, GameFightEffectTriggerCount[] fxTriggerCounts)
    {
    ...
    public override void Serialize(IDataWriter writer)
    {
        ...
        for (uint _i5 = 0; _i5 < fxTriggerCounts.Length; _i5++)
        {
            (fxTriggerCounts[_i5] as GameFightEffectTriggerCount).Serialize(writer);
        }
    ...
    public override void Deserialize(IDataReader reader)
    {
        ...
        GameFightEffectTriggerCount _item5 = null;
        ...
        for (uint _i5 = 0; _i5 < _fxTriggerCountsLen; _i5++)
        {
            _item5 = new GameFightEffectTriggerCount();
            _item5.Deserialize(reader);
            fxTriggerCounts[_i5] = _item5;
        }
