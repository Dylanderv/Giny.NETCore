...
{
    public new const ushort Id = 7814;
    ...
    public GameFightResumeWithSlavesMessage(GameFightResumeSlaveInfo[] slavesInfo, FightDispellableEffectExtendedInformations[] effects, GameActionMark[] marks, short gameTurn, int fightStart, GameFightEffectTriggerCount[] fxTriggerCounts, GameFightSpellCooldown[] spellCooldowns, byte summonCount, byte bombCount)
    {
