...
{
    public new const ushort Id = 1829;
    ...
    public GameFightResumeMessage(GameFightSpellCooldown[] spellCooldowns, byte summonCount, byte bombCount, FightDispellableEffectExtendedInformations[] effects, GameActionMark[] marks, short gameTurn, int fightStart, GameFightEffectTriggerCount[] fxTriggerCounts)
    {
