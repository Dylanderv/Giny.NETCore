...
public class CharacterDeletionPrepareRequestMessage : NetworkMessage
{
    ...
    public CharacterDeletionPrepareRequestMessage(long characterId)
    {
    ...
    public override void Deserialize(IDataReader reader)
    {
        ...
        if (characterId < 0 || characterId > 9007199254740992)
        {
            throw new System.Exception("Forbidden value (" + characterId + ") on element of CharacterDeletionPrepareRequestMessage.characterId.");
        }
