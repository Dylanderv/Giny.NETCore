...
public class AllianceRightsUpdateMessage : NetworkMessage
{
    public const ushort Id = 7383;
    ...
    public AllianceRightsUpdateMessage(int rankId, int[] rights)
    {
        this.rankId = rankId;
        this.rights = rights;
    }
    ...
    public override void Deserialize(IDataReader reader)
    {
        ...
        if (rankId < 0)
        {
            throw new System.Exception("Forbidden value (" + rankId + ") on element of AllianceRightsUpdateMessage.rankId.");
        }
