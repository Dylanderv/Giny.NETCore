...
public class Item : IDataObject, IIndexedData
{
    ...
    public double recyclingNuggets;
    public List<uint> favoriteRecyclingSubareas;
    ...
    public double RecyclingNuggets
    {
        get
        {
            return recyclingNuggets;
        }
        set
        {
            recyclingNuggets = value;
        }
    }
    [D2OIgnore]
    public List<uint> FavoriteRecyclingSubareas
    {
        get
        {
            return favoriteRecyclingSubareas;
        }
        set
        {
            favoriteRecyclingSubareas = value;
        }
    }
    [D2OIgnore]
    public List<uint> ContainerIds
